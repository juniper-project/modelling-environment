 ...
 */
public class JuniperIDEModuleSession extends DefaultModuleSession {
	 ...
	 */
	public JuniperIDEModuleSession(JuniperIDEModule module) {
		super(module);
	}
	...
	public boolean start() throws ModuleException {
	    ...
	    File softwareStylefile = new File(module.getConfiguration().getModuleResourcesPath()+"/res/style/softwareDiagramStyle.style");
	    Modelio.getInstance().getDiagramService().registerStyle("softwareDiagramStyle","main", softwareStylefile);
