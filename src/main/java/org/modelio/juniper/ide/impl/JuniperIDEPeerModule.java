...
import org.modelio.juniper.ide.api.IJuniperIDEPeerModule;
 ...
 *
 */
public class JuniperIDEPeerModule implements IJuniperIDEPeerModule {
    private JuniperIDEModule module;
	
    private IModuleAPIConfiguration peerConfiguration;
    
	public JuniperIDEPeerModule(JuniperIDEModule statModuleModule, IModuleAPIConfiguration peerConfiguration) {
		super();
