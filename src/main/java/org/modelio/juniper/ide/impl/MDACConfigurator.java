...
import org.modelio.juniper.ide.command.diagram.util.IElementCreationListener;
	...
	public static class RunJavaMdacCommand extends ElementCreatorCommand  {
	    ...
	    public void setElementCreationListener(
			...
			if (command instanceof ElementCreatorCommand) {
				((ElementCreatorCommand)command).setElementCreationListener(elementCreationListener);				
			}	    	
		}
...
public static class ElementFactory {
	...
	public Package createJUNIPERApplication(ModelTree parent) {
		...
		try(ITransaction transaction = session.createTransaction("JUNIPER Application")) {
			...
			el1.addStereotype("JavaDesigner", "JavaPackage");
			...
			el3 = CreateSingleElementMdacCommand.createSingleElement(el2, "StaticDiagram", "BusinessObjectDiagram", "JuniperIDE", "Product");
			el3.setName("Diagram");
			el2 = CreateSingleElementMdacCommand.createSingleElement(el1, "StaticDiagram", "SoftwareArchitectureDiagram","JuniperIDE", "Product");
			el2.setName("Diagram");
		/*	IStyleHandle style = Modelio.getInstance().getDiagramService().getStyle("softwareDiagramStyle");
			IDiagramHandle diagramHandler = Modelio.getInstance().getDiagramService().getDiagramHandle((AbstractDiagram )el2);
